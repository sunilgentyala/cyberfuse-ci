...
setup(
    ...
    author="Sunil Gentyala, Sunil Kumar Mudusu, Praveen Kumar Mannam, Sathish Allam, Rakesh Prakash, Satish Kumar Allani",
author_email="sunil.gentyala@ieee.org, satishkumarallani@ieee.org",
